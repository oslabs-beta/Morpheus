...
Aim to organize the response by metrics and include specific pods/services/deployments and their metrics/numbers, if relevant. Use line breaks, numbering, bullets, and bolding for organization. Limit your response to under 1500 tokens.`;
    ...
    //Used 'opinion' in prompt to get more judgement rather than only objective facts. In some models, disallow certain formatting. Bold can result in '**' and headings in '###'.
