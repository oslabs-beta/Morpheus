...
const Dashboard: React.FC = () => {
  ...
  const getIframeSource = ({ panelId }: IframeProps): string => {
    // const to = timestamp;
  ...
  const getIframeSource2 = ({ panelId }: IframeProps): string => {
    // const to = timestamp;
    // const from = to - timeRange * 1000; &from=${from}&to=${to}
    ...
    <Box className={styles.pageBackground}>
      ...
      <Box>
        <Grid container spacing={2} className={styles.topCardsContainer}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Paper className={styles.dataCardGrid1}>
              <div className={styles.cardHeaderMemory}>RAM status</div>
        ...
        <Grid container marginY={2} spacing={4}>
          <Grid item xs={12}>
            <Paper className={styles.dataCardGrid2}>
              <div className={styles.cardHeaderCPU}>CPU Usage</div>
              <iframe src={getIframeSource({ panelId: 70 })}></iframe>
            </Paper>
          </Grid>
          <Grid item xs={12}>
            <Paper className={styles.dataCardGrid2}>
              <div className={styles.cardHeaderMemory}>Memory Usage</div>
        ...
        <Grid container marginY={2} spacing={2} className={styles.topCardsContainer}>
          <Grid item xs={12} md={6}>
            <Paper className={styles.thirdGridItems}>
              <div className={styles.cardHeaderMemory}>Memory Usage detailed</div>
              <iframe src={getIframeSource({ panelId: 6 })}></iframe>
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={styles.thirdGridItems}>
              <div className={styles.cardHeaderNetwork}>Network data detailed</div>
        ...
        <Grid container marginY={2} spacing={2} className={styles.topCardsContainer}>
          <Grid item xs={12} md={6}>
            <Paper className={styles.thirdGridItems}>
              <div className={styles.cardHeaderCPU}>Extended CPU data</div>
              <iframe src={getIframeSource2({ panelId: 1 })}></iframe>
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={styles.thirdGridItems}>
              <div className={styles.cardHeaderCPU}>Cached Mem data</div>
        ...
        <Grid container marginY={2} spacing={2} className={styles.topCardsContainer}>
          <Grid item xs={12} md={6}>
            <Paper className={styles.thirdGridItems}>
              <div className={styles.cardHeaderNetwork}>Sent packets Data</div>
              <iframe src={getIframeSource2({ panelId: 9 })}></iframe>
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={styles.thirdGridItems}>
              <div className={styles.cardHeaderNetwork}>Received Packets Data</div>
